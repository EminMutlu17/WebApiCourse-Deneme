...
namespace Repository
{
    public class ProjectRepository : RepositoryBase<Project>, IProjectRepository
    {
        ...
        public IEnumerable<Project> GetAllProjects(bool trackChanges)=> FindAll(trackChanges)
            .OrderBy(p=>p.Name)
            .ToList();


        public Project GetOneProjectById(Guid id, bool trackChanges) => FindByCondition(p => p.ID.Equals(id), trackChanges)
            .SingleOrDefault();
